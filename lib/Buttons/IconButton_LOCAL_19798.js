...
var IconButton = function (_Component) {
  ...
  _createClass(IconButton, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['iconClassName', 'children', 'className', 'href', 'type', 'tooltip', 'tooltipClassName', 'tooltipPosition', 'disabled']);
      ...
      var wrappedButton = _react2.default.createElement(
        _Inks2.default,
        { disabled: disabled },
        _react2.default.createElement(href ? 'a' : 'button', btnProps, displayedChildren)
      );
