...
var TextField = function (_Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['className', 'containerClassName', 'label', 'placeholder', 'maxLength', 'helpText', 'errorText', 'floatingLabel', 'icon', 'rightIcon', 'lineDirection', 'rows', 'maxRows', 'style', 'required', 'helpOnFocus', 'fullWidth', 'defaultValue']);
